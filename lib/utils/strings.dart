...
const String kCinemaIcon = "assets/images/cinema.png";
...
const String kPepsi = "assets/images/pepsi.png";
const String kCombo1 = "assets/images/combo1.png";
const String kCombo2 = "assets/images/combo2.png";
const String kScanIcon = "assets/images/scan.png";

const String kSingleSeat = "assets/images/singleSeat.png";
...
const String kSetNotiLabel = "Set Notification";

const String kAllTabLabel = "All";
const String kComboTabLabel = "Combo";
const String kSnackTabLabel = "Snack";
const String kPopCornTabLabel = "PopCorn";
const String kBeverageTabLabel = "Beverage";
...
const String kSearchTheCinema = "search the cinema";
...
const String kShowTimes = "Show Times";
const String kKs3500 = "3,500Ks";
const String kKs29500 = '29,500Ks';
const String kFacilities = "Facilities";
const String kFormat = "Format";
const String kCinemaDetails = "Cinema Details";

const String kThermal = "Thermal Scanning";
const String kContactless = "Contactless Security Check";
const String kSanitization = "Sanitization Before Every Show";
const String kDisposable = "Disposable 3D glass";
const String kService = "Contactless Food Service";
const String kPackage = "Package Food";
const String kDeep = "Deep Cleaning of rest room";
const String kSafety = "Safety";
const String kTicketInfo = "Ticket Information";
const String kRefund = "Refund Amount";
const String kCancelBooking = "Cancel Booking";
const String kTicketDetails = "Ticket Details";
